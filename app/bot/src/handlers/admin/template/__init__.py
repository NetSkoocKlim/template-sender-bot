...
from app.bot.src.keyboards.admin.menu import get_admin_panel_template_menu_kb, get_template_edit_inline_kb

from .add import router as template_add_router
from .edit import router as template_edit_router
from app.bot.src.states.states import TemplateEditStates, TemplateAddStates
