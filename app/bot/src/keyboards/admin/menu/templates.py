...
from app.bot.src.keyboards.admin.constants import AdminPanelTemplateOptions, TemplateEditAction
from app.bot.src.keyboards.admin.fabrics import TemplateEditData
